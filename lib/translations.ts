export const translations = {
  de: {
    ...
    // VerlaufTab — Zielanalyse
    goalAnalysisTitle: "Zielanalyse",
    plannedSection: "Geplant",
    actualSection: "Tatsächlich",
    forecastSection: "Prognose",
    calorieTargetLabel: "Kalorienziel",
    tdeeLabel: "Tagesverbrauch (TDEE)",
    plannedDeficitLabel: "Geplantes Defizit",
    avgCalorieIntake: "Ø Kalorienaufnahme",
    avgEnergyDeficit: "Ø Energiedefizit",
    ...
    tipAvgDiff: "Ø Kalorienaufnahme − Kalorienziel.\n\n+ (positiv) → über Ziel\n− (negativ) → unter Ziel ✓\n0 → Ziel exakt getroffen",
  ...
  ru: {
    ...
    // VerlaufTab — Zielanalyse
    goalAnalysisTitle: "Анализ цели",
    plannedSection: "Запланировано",
    actualSection: "Фактически",
    forecastSection: "Прогноз",
    calorieTargetLabel: "Цель ккал",
    tdeeLabel: "Расход в день (TDEE)",
    plannedDeficitLabel: "Запланированный дефицит",
    avgCalorieIntake: "Ø Потребление ккал",
    avgEnergyDeficit: "Ø Дефицит энергии",
    ...
    tipAvgDiff: "Ø потребление − Цель ккал.\n\n+ (плюс) → выше цели\n− (минус) → ниже цели ✓\n0 → цель точно достигнута",
